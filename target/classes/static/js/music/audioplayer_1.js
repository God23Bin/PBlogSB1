...
(function($) {
    ...
    $.fn.audioplayer = function(o) {
        var defaults = {
            ...
            ,settings_php_handler: '' // -- the path of the publisher.html file, this is used to handle comments, likes etc.
            ,php_retriever: 'soundcloudretriever.html' // -- the soundcloud php file used to render soundcloud files
            ...
            ,skinwave_comments_enable: 'off' // -- enable the comments, publisher.html must be in the same folder as this html
        ...
        this.each(function() {
            ...
            function init() {
                ...
                if (type == 'soundcloud') {
                    ...
                    var soundcloud_retriever = o.html_retriever + '?scurl=' + aux;
